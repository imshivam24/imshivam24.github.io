    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-we-are-delighted-to-share-that-our-research-article-data-driven-massive-reaction-networks-reveal-mechanistic-pathways-underlying-catalytic-co-hydrogenation-has-been-accepted-for-publication-in-nature-communications",
          title: 'We are delighted to share that our research article, “Data-driven massive reaction networks...',
          description: "",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/1_al_cu_saa/";
            },},{id: "projects-unsteady-state-microkinetic-modeling",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/2_transient_mkm/";
            },},{id: "projects-data-driven-massive-reaction-networks",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/3_massive_reaction_networks/";
            },},{id: "projects-bulk-vs-2d-electrocatalysts-for-co-rr",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%73%68%69%76%61%6D%63%68%61%74%75%72@%69%69%73%63.%61%63.%69%6E", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=xq9z4ToAAAAJ", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/imshivam24", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/shivam-che", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0003-3784-5923", "_blank");
        },
      },{
      id: 'light-theme',
