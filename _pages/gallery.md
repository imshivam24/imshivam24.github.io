...
permalink: /gallery/
title: gallery
description: photos from talks, posters, and conferences.
nav: true
nav_order: 6
---
...
<div class="gallery-section">
  ...
  <div class="row row-cols-1 row-cols-md-3 g-3">
    <div class="col">
      {% include figure.liquid path="assets/img/gallery/ics26-iisc.jpg" class="img-fluid rounded z-depth-1" zoomable=true caption="Presenting at the IISc Chemical Engineering Symposium (Jan 2026)." %}
    </div>
  </div>
</div>
...
<div class="gallery-section mt-4">
  <h4>ICCCU25, JNCASR, Bangalore — Dec 2025</h4>
  <p class="text-muted">Poster: Transient Microkinetic Modeling of Electrochemical Mechanisms</p>
  <div class="row row-cols-1 row-cols-md-3 g-3">
    <div class="col">
...
<div class="gallery-section mt-4">
  <h4>2nd Divisional Research Symposium, IISc — May 2024</h4>
  <p class="text-muted">Poster: Copper's Missing Piece — Screening Cu Single-Atom Alloys for CO₂ Reduction to Propylene</p>
  <div class="row row-cols-1 row-cols-md-3 g-3">
    <div class="col">
      {% include figure.liquid path="assets/img/gallery/divisional-symposium-iisc.jpg" class="img-fluid rounded z-depth-1" zoomable=true caption="Poster presentation at the 2nd Divisional Research Symposium, IISc (May 2024)." %}
    </div>
  </div>
</div>

<div class="gallery-section mt-4">
  <h4>Namma Psi-k, JNCASR, Bangalore — Jul 2023</h4>
  <p class="text-muted">AI/ML for 2D Materials</p>
  <div class="row row-cols-1 row-cols-md-3 g-3">
    <div class="col">
      {% include figure.liquid path="assets/img/gallery/namma-psik-1.jpg" class="img-fluid rounded z-depth-1" zoomable=true caption="Namma Psi-k, JNCASR, Bangalore (Jul 2023)." %}
    </div>
    <div class="col">
      {% include figure.liquid path="assets/img/gallery/namma-psik-2.jpg" class="img-fluid rounded z-depth-1" zoomable=true caption="Namma Psi-k, JNCASR, Bangalore (Jul 2023)." %}
    </div>
  </div>
</div>
