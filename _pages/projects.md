...
- **Shell Technology Centre (STC), Bangalore** — *Unsteady-State Microkinetic Modeling of Electrochemical CO₂ Reduction* (Apr 2023 – Oct 2024)
...
- **Malaviya National Institute of Technology, Jaipur** — *Development of a Bio-Adsorbent for Arsenic Removal Using a Hydrothermal Process* (Aug 2021 – Mar 2022)
...
- **IASc–INSA–NASI Summer Research Fellowship Programme** (Remote) — *Analyzing COVID-19 Spread in Chest X-rays Using CNNs* (Jun 2020 – Jul 2020)
...
- **Institute of Technology & Management, Salt Lake** (Remote) — *Predicting the Viscosity of Various Nanofluids Using Artificial Neural Networks* (Aug 2020 – Feb 2021)
  Supervisor: Dr. Satyasaran Changdar
  - Explored a physics-guided neural network framework to develop a generalized model for predicting nanofluid viscosity with high accuracy
